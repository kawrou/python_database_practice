...
class DatabaseConnection:
    ...
    # My comments: 
    # I haven't learnt what .connection & .connect is but know that it is some syntax used for connecting to database
    def connect(self):
        try:
    ...
    # My comments:
    # This method just finds the path of the SQL file and then opens and reads the file into the PostgreSQL database. 
    ...
    # My comments:
    # Not sure how to explain what this method does
